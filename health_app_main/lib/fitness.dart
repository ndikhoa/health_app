...
// lấy dữ liệu api trên ExerciseDB ( chuyên về các bài tập sức khỏe)
...
class _FitnessScreenState extends State<FitnessScreen> {
  ...
  List<String> gifFileNames =
      List.generate(10, (index) => 'assets/gifs/gif${index + 1}.gif');
  ...
  // http.get thuc hien tat ca cac thao tac nhu : (read, create, update, delete)
