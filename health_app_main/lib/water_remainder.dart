...
class _WaterReminderState extends State<WaterReminder> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        padding:
            EdgeInsets.only(top: 8.0), // Add padding between app bar and image
        child: Stack(
          children: [
            Positioned(
              ...
              child: Image.asset(
                "assets/glass2.jpeg", // Check the path to your image
                fit: BoxFit.cover,
            ...
            Positioned(
              ...
              child: Container(
                width: MediaQuery.of(context).size.width -
                    100, // Adjust the width of the container to fill the screen width with padding
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(
                        height:
                            20), // Add space between the texts and the rectangle
                    Padding(
                      padding: EdgeInsets.symmetric(
                          horizontal:
                              16), // Add padding to the left and right of the rectangle
                      child: Container(
                        padding: EdgeInsets.all(12),
                        decoration: BoxDecoration(
                          border: Border.all(
                              color: Colors
                                  .blueGrey), // Add border to the container
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              '16:00 giờ', // Time example, replace it with the actual time
                              style: TextStyle(
                                fontSize: 13,
                                color: Colors.blueGrey,
                              ),
                    ...
                    SizedBox(
                        height:
                            20), // Add space between the rectangle and the bottom of the container
                  ],
                ),
              ),
            ),
